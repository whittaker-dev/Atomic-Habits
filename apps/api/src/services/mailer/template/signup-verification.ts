export interface SignupVerificationMailInput {
  code: string;
...
export function buildSignupVerificationMailHtml({
  code,
  expiresMinutes,
}: SignupVerificationMailInput): string {
                ...
                <tr>
                  <td class="email-header" style="padding:28px 28px 20px;background-color:#121212;border-bottom:1px solid #2a2a2a;">
                    ...
                    <p class="email-subtitle" style="margin:14px 0 0;font-family:Inter,Arial,Helvetica,sans-serif;font-size:13px;line-height:1.5;color:#b3b3b3;">
                      Enter this code to finish creating your account. It expires in ${safeExpiry} minutes.
                    </p>
                  </td>
                </tr>
              </table>
...
export function buildSignupVerificationMailText({
  code,
  expiresMinutes,
}: SignupVerificationMailInput): string {
  return [
    'ATOMIC HABITS — VERIFY YOUR ACCOUNT',
    '═'.repeat(40),
    '',
