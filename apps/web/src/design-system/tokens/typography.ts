export const typography = {
  displayXl: { size: '80px', weight: 700, lineHeight: 1.05, letterSpacing: '-3px' },
  displayLg: { size: '56px', weight: 700, lineHeight: 1.1, letterSpacing: '-1.8px' },
  displayMd: { size: '40px', weight: 700, lineHeight: 1.15, letterSpacing: '-1px' },
  headline: { size: '28px', weight: 700, lineHeight: 1.2, letterSpacing: '-0.6px' },
  cardTitle: { size: '22px', weight: 700, lineHeight: 1.25, letterSpacing: '-0.4px' },
